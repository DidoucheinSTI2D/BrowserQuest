...
module.exports = Player = Character.extend({
    init: function(connection, worldServer) {
        ...
        this.connection.listen(function(message) {
            ...
            if (!check(message)) {
                self.connection.close("Invalid message format: " + message);
                return;
            }
            ...
            if (action === Types.Messages.HELLO) {
                ...
                self.name = (name === "") ? "lorem ipsum" : name.substr(0, 15); // sanitize and limit name length
                ...
                if (msg && msg !== "") {
                    msg = msg.substr(0, 60); // Enforce max length of 60 characters
